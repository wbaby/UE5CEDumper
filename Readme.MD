...
| Feature | Description |
|---|---|
| **AOB Scanning** | 87 entries (82 patterns + 5 exports) from 6 sources. Supports `FChunkedFixed` and `FFixed` object arrays. Encrypted GObjects + preset layout detection. |
